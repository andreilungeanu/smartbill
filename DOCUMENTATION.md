...
**Method:** `Smartbill::invoices()->create(array $data)` (Note: uses v2 endpoint)
...
### Stornare factura
**Method:** `Smartbill::invoices()->reverse(array $data)`
...
**Method:** `Smartbill::estimates()->create(array $data)` (Note: uses v2 endpoint)
...
**Method:** `Smartbill::estimates()->getInvoiceStatus(string $cif, string $seriesName, string $number)`
...
**Method:** `Smartbill::payments()->getText(string $cif, int $id)`
...
**Method:** `Smartbill::payments()->delete(array $queryParams)`
...
**Method:** This endpoint is not yet implemented in the package.
